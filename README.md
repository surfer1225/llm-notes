...
- Tactic 5: give the model an identity
...
- Temperature is the degree of freedom (e.g. if your favorite food is 53% pizza, 30% sushi, temperature of 0 will always give pizza, while 0.3 will sometimes give sushi)
- Do not spam
### Sample tasks
